...
MomentPicker = (function(superClass) {
  ...
  MomentPicker.prototype._renderFakeInput = function() {
    ...
    if (this.opts.allowClear) {
      this.inputWrap = $('<div/>').addClass('momentpicker-input-wrapper').css({
        'display': 'inline-block'
      }).append(this.input).append('<span class="link-clear">&#10005;</span>').insertAfter(this.el);
    } else {
  ...
  MomentPicker.prototype._bind = function() {
    ...
    if (this.opts.allowClear) {
      this.inputWrap.find('.link-clear').on('mousedown', (function(_this) {
        return function() {
          _this.el.val('');
